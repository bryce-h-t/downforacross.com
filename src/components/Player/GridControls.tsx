...
interface GridControlsProps {
  grid: any[][]; // Replace 'any' with the actual type of your grid cells
...
export default class GridControls extends Component<GridControlsProps, GridControlsState> {
  ...
  getSelectedClueNumber(): string | number {
  ...
  selectNextClue(backwards: boolean, parallel: boolean = false): void {
  ...
  selectClue(direction: string, number: string | number): void {
  ...
  setDirectionWithCallback(direction: string, cbk: () => void): () => void {
    return () => {
