...
import {EmojiPickerProps, EmojiPickerState, DOMPosition, EmojiMatch} from './types';
...
export default class EmojiPicker extends React.Component<EmojiPickerProps, EmojiPickerState> {
  public readonly state: EmojiPickerState;
  public static displayName = 'EmojiPicker';
  ...
  static getDerivedStateFromProps(nextProps: EmojiPickerProps, prevState: EmojiPickerState) {
  ...
  handleMouseEnterSpan = (e: React.MouseEvent<HTMLSpanElement>) => {
